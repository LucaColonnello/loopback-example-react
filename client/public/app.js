...
/***/ function(module, exports, __webpack_require__) {
	...
	_router2['default'].run(function (Handler, state) {
		_react2['default'].render(_react2['default'].createElement(Handler, state), document.getElementById('app-container'));
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var router = _reactRouter2['default'].create({
		routes: [_react2['default'].createElement(
			Route,
			{ handler: _components.App },
			_react2['default'].createElement(Route, { path: '/', handler: _components.IndexPage }),
			_react2['default'].createElement(Route, { path: '/me', handler: _components.UserPage }),
			_react2['default'].createElement(Route, { path: '/login', handler: _components.LoginPage }),
			_react2['default'].createElement(Route, { path: '/register', handler: _components.RegisterPage }),
			_react2['default'].createElement(Route, { path: '/my/todos', handler: _components.TodosPage })
		)]
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _UserPage = __webpack_require__(200);
	
	var _UserPage2 = _interopRequireDefault(_UserPage);
	
	var _LoginPage = __webpack_require__(201);
	
	var _LoginPage2 = _interopRequireDefault(_LoginPage);
	
	var _RegisterPage = __webpack_require__(202);
	
	var _RegisterPage2 = _interopRequireDefault(_RegisterPage);
	
	var _TodosPage = __webpack_require__(203);
	...
	exports['default'] = {
		...
		UserPage: _UserPage2['default'],
		LoginPage: _LoginPage2['default'],
		RegisterPage: _RegisterPage2['default'],
...
/***/ function(module, exports, __webpack_require__) {
	...
	var IndexPage = (function (_React$Component) {
		function IndexPage(props, context) {
			...
			_get(Object.getPrototypeOf(IndexPage.prototype), "constructor", this).call(this, props, context);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var UserPage = (function (_React$Component) {
		function UserPage(props, context) {
			_classCallCheck(this, UserPage);
	
			_get(Object.getPrototypeOf(UserPage.prototype), 'constructor', this).call(this, props, context);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var TodosPage = (function (_React$Component) {
		function TodosPage(props, context) {
			...
			_get(Object.getPrototypeOf(TodosPage.prototype), "constructor", this).call(this, props, context);
		...
		_createClass(TodosPage, [{
			...
			value: function render() {
				return _react2["default"].createElement(
					"div",
					null,
					_react2["default"].createElement("section", { id: "todoapp" }),
					_react2["default"].createElement(
						"footer",
						{ id: "info" },
						_react2["default"].createElement(
